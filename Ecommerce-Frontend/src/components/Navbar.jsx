...
const Navbar = ({ onSelectCategory, onSearch }) => {
  ...
  const fetchData = async (value) => {
    try {
      const response = await axios.get("https://ecommerce-backend-sod2.onrender.com/api/products");
  ...
  const handleChange = async (value) => {
    ...
    try {
      const response = await axios.get(
        `https://ecommerce-backend-sod2.onrender.com/api/products/search?keyword=${value}`
      );
      setSearchResults(response.data);
  ...
  //         response = await axios.get(`https://ecommerce-backend-sod2.onrender.com/api/products/search?id=${value}`);
  //       } else {
  //         // Input is not a number, search by keyword
  //         response = await axios.get(`https://ecommerce-backend-sod2.onrender.com/api/products/search?keyword=${value}`);
  //       }
