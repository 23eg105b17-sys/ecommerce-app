...
const Product = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get(
          `https://ecommerce-backend-sod2.onrender.com/api/product/${id}`
        );
    ...
    const fetchImage = async () => {
      const response = await axios.get(
        `https://ecommerce-backend-sod2.onrender.com/api/product/${id}/image`,
        { responseType: "blob" }
      );
  ...
  const deleteProduct = async () => {
    try {
      await axios.delete(`https://ecommerce-backend-sod2.onrender.com/api/product/${id}`);
      removeFromCart(id);
